...
## Extension lane: multi-node simulation

If time allows:

- Add an additional worker node (if environment supports it)
- Observe pod scheduling behavior
- Describe how Kubernetes chooses nodes

Research and document your findings.

---

## Extension lane: database hardening

Modify your database setup:

- Use a Kubernetes Secret for credentials
- Mount environment variables from the secret
...
## Extension lane: autoscaling exploration
...
No full implementation required unless you complete all prior tasks.

---

## Extension lane: architecture critique
...
This lane is intentionally difficult.
...
- Split your application and database into separate namespaces and update access rules.
- Add a basic Ingress resource and explain how it would connect to a real load balancer.
...
This section is used for differentiation in grading.
