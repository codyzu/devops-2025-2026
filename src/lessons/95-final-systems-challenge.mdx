...
Focus on issues that would matter in a real production system.

For each problem explain:

- What the problem is
- Why it matters
- What failure or operational risk it could cause
...
- What Kubernetes controllers are responsible for recovery

Keep the explanation short. A few clear paragraphs or bullet points are enough.
...
If you finish early, consider the following questions and add a short section to your notes.
